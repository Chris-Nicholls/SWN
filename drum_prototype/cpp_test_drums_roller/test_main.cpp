/*
 * test_main.cpp — drives the ROLLER-style voices (kick, snare, closed hat,
 * open hat, ride, crash, perc, rimshot) through default, long-decay,
 ...
 * plus an FFT peak/centroid so the result can be compared against
 * py_roller_*.wav in drum_prototype/).
 *
 * The "default" scenarios reproduce render_roller_style_drums.py's own
 * defaults as closely as the knob ranges allow, so compare_to_python.py
 * has something meaningful to line up against.
 *
 * Usage:
 *   ./drumtest_roller [out_dir]
 */
extern "C" {
...
int main(int argc, char **argv)
{
	...
	std::vector<VoiceCase> cases = {
		{"kick", &drum_voice_roller_kick, {
			{"kick_default",     0.0f, 1.0f,  0.28f, 0.36f, 0.8f},
			{"kick_longdecay",   0.0f, 1.0f,  1.0f,  0.36f, 1.4f},
			{"kick_lowfilter",   0.0f, 0.15f, 0.28f, 0.36f, 0.8f},
			{"kick_low",         0.0f, 1.0f,  0.28f, 0.0f,  0.8f},
			{"kick_high",        0.0f, 1.0f,  0.28f, 1.0f,  0.8f},
		}},
		{"snare", &drum_voice_roller_snare, {
			{"snare_default",    0.0f, 1.0f,  0.20f, 0.62f, 0.6f},
			{"snare_longdecay",  0.0f, 1.0f,  1.0f,  0.62f, 1.0f},
			{"snare_lowfilter",  0.0f, 0.15f, 0.20f, 0.62f, 0.6f},
			{"snare_nosnap",     0.0f, 1.0f,  0.20f, 0.0f,  0.6f},
			{"snare_maxsnap",    0.0f, 1.0f,  0.20f, 1.0f,  0.6f},
		}},
		{"closed_hat", &drum_voice_roller_closed_hat, {
			{"chat_default",     0.0f, 1.0f,  0.21f, 0.4f,  0.3f},
			{"chat_longdecay",   0.0f, 1.0f,  1.0f,  0.4f,  0.4f},
			{"chat_lowfilter",   0.0f, 0.15f, 0.21f, 0.4f,  0.3f},
			{"chat_dark",        0.0f, 1.0f,  0.21f, 0.0f,  0.3f},
			{"chat_bright",      0.0f, 1.0f,  0.21f, 1.0f,  0.3f},
		}},
		{"open_hat", &drum_voice_roller_open_hat, {
			{"ohat_default",     0.0f, 1.0f,  0.22f, 0.4f,  0.6f},
			{"ohat_longdecay",   0.0f, 1.0f,  1.0f,  0.4f,  1.4f},
			{"ohat_lowfilter",   0.0f, 0.15f, 0.22f, 0.4f,  0.6f},
			{"ohat_dark",        0.0f, 1.0f,  0.22f, 0.0f,  0.6f},
			{"ohat_bright",      0.0f, 1.0f,  0.22f, 1.0f,  0.6f},
		}},
		{"ride", &drum_voice_roller_ride, {
			{"ride_default",     0.0f, 1.0f,  0.18f, 0.4f,  1.2f},
			{"ride_longdecay",   0.0f, 1.0f,  1.0f,  0.4f,  3.0f},
			{"ride_lowfilter",   0.0f, 0.15f, 0.18f, 0.4f,  1.2f},
			{"ride_dark",        0.0f, 1.0f,  0.18f, 0.0f,  1.2f},
			{"ride_bright",      0.0f, 1.0f,  0.18f, 1.0f,  1.2f},
		}},
		{"crash", &drum_voice_roller_crash, {
			{"crash_default",    0.0f, 1.0f,  0.52f, 0.4f,  2.4f},
			{"crash_longdecay",  0.0f, 1.0f,  1.0f,  0.4f,  4.0f},
			{"crash_lowfilter",  0.0f, 0.15f, 0.52f, 0.4f,  2.4f},
			{"crash_dark",       0.0f, 1.0f,  0.52f, 0.0f,  2.4f},
			{"crash_bright",     0.0f, 1.0f,  0.52f, 1.0f,  2.4f},
		}},
		{"perc", &drum_voice_roller_perc, {
			{"perc_default",     0.0f, 1.0f,  0.09f, 0.33f, 0.4f},
			{"perc_longdecay",   0.0f, 1.0f,  1.0f,  0.33f, 1.2f},
			{"perc_lowfilter",   0.0f, 0.15f, 0.09f, 0.33f, 0.4f},
			{"perc_low",         0.0f, 1.0f,  0.09f, 0.0f,  0.4f},
			{"perc_high",        0.0f, 1.0f,  0.09f, 1.0f,  0.4f},
		}},
		{"rimshot", &drum_voice_roller_rimshot, {
			{"rim_default",      0.0f, 1.0f,  0.15f, 0.33f, 0.2f},
			{"rim_longdecay",    0.0f, 1.0f,  1.0f,  0.33f, 0.3f},
			{"rim_lowfilter",    0.0f, 0.15f, 0.15f, 0.33f, 0.2f},
			{"rim_low",          0.0f, 1.0f,  0.15f, 0.0f,  0.2f},
			{"rim_high",         0.0f, 1.0f,  0.15f, 1.0f,  0.2f},
		}},
	};
